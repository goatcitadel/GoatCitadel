...
- Chat, Cowork, and Code recall modes are explicit API/UI flows: targeted recall, broad summary recall, and post-compaction resume context. They may return inspectable context packs, feedback records, and open memory quality issues, but they must not be represented as invisible automatic prompt injection.
