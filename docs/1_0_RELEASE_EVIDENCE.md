...
- Unit-test evidence for the visibility rule lives in [apps/gateway/src/services/mcp-template-visibility.test.ts](../apps/gateway/src/services/mcp-template-visibility.test.ts), compatibility-only Mission Control surface evidence lives in [apps/mission-control/src/mission-control-hardening.test.tsx](../apps/mission-control/src/mission-control-hardening.test.tsx), and current-shell route compatibility evidence lives in [apps/mission-control-next/src/app/legacy-route-adapter.test.ts](../apps/mission-control-next/src/app/legacy-route-adapter.test.ts).
