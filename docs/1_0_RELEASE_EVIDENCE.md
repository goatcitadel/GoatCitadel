...
- Compatibility-only shell evidence for routing transparency lives in [apps/mission-control/src/components/ChatTraceCard.tsx](../apps/mission-control/src/components/ChatTraceCard.tsx) and [apps/mission-control/src/components/chat/ChatThreadView.tsx](../apps/mission-control/src/components/chat/ChatThreadView.tsx), while current-shell routing transparency is anchored in [packages/mission-control-shared/src/components/ChatTraceCard.tsx](../packages/mission-control-shared/src/components/ChatTraceCard.tsx), [packages/mission-control-shared/src/components/chat/ChatThreadView.tsx](../packages/mission-control-shared/src/components/chat/ChatThreadView.tsx), and [packages/threaded-surface-core/src/MissionThreadedControllerHost.tsx](../packages/threaded-surface-core/src/MissionThreadedControllerHost.tsx).
...
- Compatibility-only shell evidence for approval failure resilience lives in [apps/mission-control/src/pages/ApprovalsPage.tsx](../apps/mission-control/src/pages/ApprovalsPage.tsx), while canonical current-shell failure-path evidence lives in [apps/mission-control-next/src/features/native-routes/ops/ApprovalsRoutePage.tsx](../apps/mission-control-next/src/features/native-routes/ops/ApprovalsRoutePage.tsx) and [apps/mission-control-next/src/features/native-routes/ops/ApprovalsRoutePage.test.tsx](../apps/mission-control-next/src/features/native-routes/ops/ApprovalsRoutePage.test.tsx).
- Compatibility-only shell evidence for Cowork orchestration refresh lives in [apps/mission-control/src/pages/chat/useChatDockWorkbenchController.ts](../apps/mission-control/src/pages/chat/useChatDockWorkbenchController.ts), while canonical current-shell workflow state is owned by [packages/threaded-surface-core/src/MissionThreadedControllerHost.tsx](../packages/threaded-surface-core/src/MissionThreadedControllerHost.tsx), [packages/threaded-surface-core/src/cowork-view-model.ts](../packages/threaded-surface-core/src/cowork-view-model.ts), and [apps/mission-control-next/src/features/threaded-surface/ThreadedWorkflowPanel.tsx](../apps/mission-control-next/src/features/threaded-surface/ThreadedWorkflowPanel.tsx).
- Compatibility-only shell evidence for pending-approval context visibility lives in [apps/mission-control/src/pages/chat/useChatOutboundExecution.ts](../apps/mission-control/src/pages/chat/useChatOutboundExecution.ts), while current-shell visibility is anchored in [packages/threaded-surface-core/src/chat/chat-pending-approval.ts](../packages/threaded-surface-core/src/chat/chat-pending-approval.ts), [packages/threaded-surface-core/src/MissionThreadedControllerHost.tsx](../packages/threaded-surface-core/src/MissionThreadedControllerHost.tsx), and [packages/mission-control-shared/src/components/chat/ChatPendingApprovalPanel.tsx](../packages/mission-control-shared/src/components/chat/ChatPendingApprovalPanel.tsx).
...
- Compatibility-only shell evidence for guided Channel Setup rendering lives in [apps/mission-control/src/pages/ChannelSetupPage.tsx](../apps/mission-control/src/pages/ChannelSetupPage.tsx), while canonical current-shell guided setup rendering lives in [apps/mission-control-next/src/features/native-routes/SettingsNativePage.tsx](../apps/mission-control-next/src/features/native-routes/SettingsNativePage.tsx) and [apps/mission-control-next/src/features/native-routes/SettingsNativePage.test.tsx](../apps/mission-control-next/src/features/native-routes/SettingsNativePage.test.tsx).
- Compatibility-only shell evidence that non-guided built-ins stay out of the visible Channel Setup surface and that future/parity-deficit copy is absent lives in [apps/mission-control/src/pages/ChannelSetupPage.test.tsx](../apps/mission-control/src/pages/ChannelSetupPage.test.tsx), with current-shell integrations routing anchored in [apps/mission-control-next/src/app/route-model.ts](../apps/mission-control-next/src/app/route-model.ts) and [apps/mission-control-next/src/features/native-routes/SettingsNativePage.tsx](../apps/mission-control-next/src/features/native-routes/SettingsNativePage.tsx).
...
- Compatibility-only shell evidence for visible MCP authoring lives in [apps/mission-control/src/pages/McpPage.tsx](../apps/mission-control/src/pages/McpPage.tsx), while canonical current-shell MCP authoring lives in [apps/mission-control-next/src/features/native-routes/SettingsNativePage.tsx](../apps/mission-control-next/src/features/native-routes/SettingsNativePage.tsx) and [packages/mission-control-shared/src/api/mcp.ts](../packages/mission-control-shared/src/api/mcp.ts); the runtime rule stays on local `stdio` plus the built-in Approval Inbox template in [apps/gateway/src/services/gateway-service.ts](../apps/gateway/src/services/gateway-service.ts).
