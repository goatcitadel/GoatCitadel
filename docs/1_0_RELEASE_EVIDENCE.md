...
- Compatibility-only shell evidence for external-bound non-resumable labeling lives in [apps/mission-control/src/pages/ChatPage.tsx](../apps/mission-control/src/pages/ChatPage.tsx); replay still skips integration sessions in [apps/gateway/src/services/gateway-service.ts](../apps/gateway/src/services/gateway-service.ts). Canonical next-shell proof for this boundary must come from the named runtime/visual lanes, not from this legacy-only citation.
...
- Compatibility-only shell evidence for routing transparency lives in [apps/mission-control/src/components/ChatTraceCard.tsx](../apps/mission-control/src/components/ChatTraceCard.tsx) and [apps/mission-control/src/components/chat/ChatThreadView.tsx](../apps/mission-control/src/components/chat/ChatThreadView.tsx), with UI evidence in [apps/mission-control/src/components/ChatTraceCard.test.tsx](../apps/mission-control/src/components/ChatTraceCard.test.tsx) and [apps/mission-control/src/components/chat/ChatThreadView.test.tsx](../apps/mission-control/src/components/chat/ChatThreadView.test.tsx). It cannot be the only proof for current-shell release claims.
...
- Compatibility-only shell evidence for approval failure resilience lives in [apps/mission-control/src/pages/ApprovalsPage.tsx](../apps/mission-control/src/pages/ApprovalsPage.tsx), with failure-path evidence in [apps/mission-control/src/pages/ApprovalsPage.test.tsx](../apps/mission-control/src/pages/ApprovalsPage.test.tsx).
- Compatibility-only shell evidence for Cowork orchestration refresh lives in [apps/mission-control/src/pages/chat/useChatDockWorkbenchController.ts](../apps/mission-control/src/pages/chat/useChatDockWorkbenchController.ts), preserving last-known-good run/checkpoint state on partial refresh failures with hook-level evidence in [apps/mission-control/src/pages/chat/useChatDockWorkbenchController.test.tsx](../apps/mission-control/src/pages/chat/useChatDockWorkbenchController.test.tsx).
- Compatibility-only shell evidence for pending-approval context visibility lives in [apps/mission-control/src/pages/chat/useChatOutboundExecution.ts](../apps/mission-control/src/pages/chat/useChatOutboundExecution.ts), with regression evidence in [apps/mission-control/src/pages/chat/useChatOutboundExecution.test.tsx](../apps/mission-control/src/pages/chat/useChatOutboundExecution.test.tsx).
...
- Compatibility-only shell evidence for guided Channel Setup rendering lives in [apps/mission-control/src/pages/ChannelSetupPage.tsx](../apps/mission-control/src/pages/ChannelSetupPage.tsx).
- Compatibility-only shell evidence that non-guided built-ins stay out of the visible Channel Setup surface and that future/parity-deficit copy is absent lives in [apps/mission-control/src/pages/ChannelSetupPage.test.tsx](../apps/mission-control/src/pages/ChannelSetupPage.test.tsx).
...
- Compatibility-only shell evidence for visible MCP authoring lives in [apps/mission-control/src/pages/McpPage.tsx](../apps/mission-control/src/pages/McpPage.tsx); the runtime rule stays on local `stdio` plus the built-in Approval Inbox template in [apps/gateway/src/services/gateway-service.ts](../apps/gateway/src/services/gateway-service.ts).
...
- Unit-test evidence for the visibility rule lives in [apps/gateway/src/services/mcp-template-visibility.test.ts](../apps/gateway/src/services/mcp-template-visibility.test.ts), and compatibility-only Mission Control surface evidence lives in [apps/mission-control/src/mission-control-hardening.test.tsx](../apps/mission-control/src/mission-control-hardening.test.tsx).
