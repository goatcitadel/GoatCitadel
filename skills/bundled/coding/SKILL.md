...
1. Choose validation proportional to the risk and surface area of the change
2. For TypeScript/runtime changes, prefer targeted tests first, then broaden to `pnpm -r typecheck` or `pnpm -r test` when shared contracts or cross-package behavior changed
3. Add or update tests for bug fixes and behavior changes
4. Use smoke or verification lanes when the change touches shipped workflows, routing, or release gates
