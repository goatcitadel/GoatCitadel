...
export const GENERATED_SKILL_ROUTING_HINTS: Record<string, SkillRoutingHints> = {
  ...
  "design-intelligence": {
    ...
    whenToUse: [
      "Review or improve UI/artifact quality, visual hierarchy, responsive behavior, accessibility, anti-slop posture, design-system fit, or non-plain document/deck output.",
    ],
    whenNotToUse: [
      "Do not use for backend-only changes without user-visible UI implications or explicitly plain/raw data artifacts.",
    ],
