...
const BUILTIN_TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    riskLevel: "caution",
    requiresApproval: false,
    description: "Send message to Matrix integration.",
    pack: "comms",
  },
  {
    name: "matrix.react",
    ...
    riskLevel: "caution",
    requiresApproval: false,
    description: "Send a Matrix reaction event for a previously sent message.",
    pack: "comms",
  },
  {
    name: "matrix.unsend",
    ...
    riskLevel: "caution",
    requiresApproval: false,
    description: "Redact a previously sent Matrix event.",
    pack: "comms",
  },
  {
