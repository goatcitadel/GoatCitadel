  ...
  .object({
    ...
    features: z
      .object({
        ...
        // Kill switch for streaming the terminal synthesizer step's real model
        // tokens to the SSE client (default-on); `true` restores the buffered
        // whole-orchestration delivery with the post-hoc synthetic delta split.
