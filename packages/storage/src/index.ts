...
import { DocumentPatchProposalRepository } from "./document-patch-proposal-repo.js";
export { DocumentPatchProposalRepository } from "./document-patch-proposal-repo.js";
...
import { EngineeringLearningRepository } from "./engineering-learning-repo.js";
import { StructuredReviewRepository } from "./structured-review-repo.js";
import { PromptRetuneRepository } from "./prompt-retune-repo.js";
...
export class Storage {
  ...
  public readonly remoteWorkerCellCapacityAdmission: RemoteWorkerCellCapacityAdmissionRepository;
  public readonly remoteWorkerNativeCapacityDeliveries: RemoteWorkerNativeCapacityDeliveryRepository;
  public readonly remoteWorkerNativeCapacityPages: RemoteWorkerNativeCapacityPagesRepository;
  public readonly remoteWorkerNativePools: RemoteWorkerNativePoolRepository;
  ...
  public readonly remoteWorkerCellCapacity: RemoteWorkerCellCapacityRepository;
  public readonly remoteWorkerRuntimeResults: RemoteWorkerRuntimeResultRepository;
  public readonly remoteWorkerNativeFileReceipts: RemoteWorkerNativeFileReceiptRepository;
  public readonly remoteWorkerNativeFileTransfers: RemoteWorkerNativeFileTransferRepository;
  public readonly remoteWorkerRuntimeAdmissions: RemoteWorkerRuntimeAdmissionRepository;
  public readonly remoteWorkerRuntimeInstalls: RemoteWorkerRuntimeInstallRepository;
  public readonly remoteWorkerNativePolicyReservations: RemoteWorkerNativePolicyReservationRepository;
  public readonly remoteWorkerCellBackingCapacity: RemoteWorkerCellBackingCapacityRepository;
  ...
  public readonly documentPatchProposals: DocumentPatchProposalRepository;
  ...
  public readonly engineeringLearnings: EngineeringLearningRepository;
  public readonly structuredReviews: StructuredReviewRepository;
  public readonly promptRetunes: PromptRetuneRepository;
  ...
  public constructor(options: StorageOptions) {
    ...
    this.remoteWorkerCellCapacityAdmission = new RemoteWorkerCellCapacityAdmissionRepository(this.db);
    this.remoteWorkerNativeCapacityDeliveries = new RemoteWorkerNativeCapacityDeliveryRepository(this.db);
    this.remoteWorkerNativeCapacityPages = new RemoteWorkerNativeCapacityPagesRepository(this.db);
    this.remoteWorkerNativePools = new RemoteWorkerNativePoolRepository(this.db);
    ...
    this.remoteWorkerCellCapacity = new RemoteWorkerCellCapacityRepository(this.db);
    this.remoteWorkerRuntimeResults = new RemoteWorkerRuntimeResultRepository(this.db);
    this.remoteWorkerNativeFileReceipts = new RemoteWorkerNativeFileReceiptRepository(this.db);
    this.remoteWorkerNativeFileTransfers = new RemoteWorkerNativeFileTransferRepository(this.db);
    this.remoteWorkerRuntimeAdmissions = new RemoteWorkerRuntimeAdmissionRepository(this.db);
    this.remoteWorkerRuntimeInstalls = new RemoteWorkerRuntimeInstallRepository(this.db);
    this.remoteWorkerNativePolicyReservations = new RemoteWorkerNativePolicyReservationRepository(this.db);
    this.remoteWorkerCellBackingCapacity = new RemoteWorkerCellBackingCapacityRepository(this.db);
    ...
    this.documentPatchProposals = new DocumentPatchProposalRepository(this.db);
    ...
    this.engineeringLearnings = new EngineeringLearningRepository(this.db);
    this.structuredReviews = new StructuredReviewRepository(this.db);
    this.promptRetunes = new PromptRetuneRepository(this.db);
...
export * from "./remote-worker-cell-capacity-admission-repo.js";
export * from "./remote-worker-native-capacity-delivery-repo.js";
export * from "./remote-worker-native-pool-capacity-delivery-repo.js";
export * from "./remote-worker-native-capacity-pages-repo.js";
export * from "./remote-worker-native-pool-repo.js";
export * from "./remote-worker-runtime-read-repo.js";
export * from "./remote-worker-cell-provisioning-repo.js";
export * from "./remote-worker-cell-capacity-repo.js";
export * from "./remote-worker-cell-backing-capacity-repo.js";
...
export * from "./document-patch-proposal-repo.js";
...
export * from "./engineering-learning-repo.js";
export * from "./structured-review-repo.js";
export * from "./prompt-retune-repo.js";
