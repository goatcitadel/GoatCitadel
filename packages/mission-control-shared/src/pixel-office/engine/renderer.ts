// eslint-disable-next-line @typescript-eslint/ban-ts-comment -- Pixel-office canvas renderer still needs a strict indexing pass.
// @ts-nocheck
import {
...
import { BUBBLE_PERMISSION_SPRITE, BUBBLE_WAITING_SPRITE, getCharacterSprites } from "../sprites/spriteData";
import type { Character, FloorColor, FurnitureInstance, Seat, SpriteData, TileType as TileTypeVal } from "../types";
