...
Expanded overnight hardening pack for recently added GoatCitadel capabilities. This version keeps the v2 coverage, raises the answer-quality bar, and adds cross-system seam tests for durable execution, approvals, lifecycle truth, Mission Control truthfulness, and multi-worker recovery.
