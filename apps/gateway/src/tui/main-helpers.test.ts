  ...
  it("builds stable navigation and header decisions for the terminal shell", () => {
    ...
    expect(
      buildHeaderSummaryRows({
        ...
        activeSessionId: "session-code-1234567890",
        changedFiles: 3,
        codeModeRuns: 2,
      }),
    ).toEqual([
      ...
      { key: "Provider", value: "openai / gpt-5.1-codex" },
      { key: "Session", value: "session-code-1234567890" },
      { key: "Changes", value: "3 files" },
      { key: "Code Mode", value: "2 runs" },
