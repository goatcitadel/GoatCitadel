  ...
  it("preserves idempotency claims for every committed permission and local-override mutation", async () => {
    ...
    const scenarios = [
      ...
      },
      {
        ...
        payload: { description: "updated", expectedRevision: "a".repeat(64) },
      ...
      },
      {
        ...
        method: "POST" as const,
        payload: { expectedProfileRevision: "a".repeat(64), expectedSelectionRevision: "b".repeat(64), profileId: "profile-owned", surface: "chat" },
