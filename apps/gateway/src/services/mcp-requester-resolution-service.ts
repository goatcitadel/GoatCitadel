...
import { freezeRequesterScopedProfileTool, freezeRequesterScopedProfileCatalog } from "./mcp-requester-profile-freeze.js";
...
export async function resolveRequesterScopedBindingForProfileFreeze(
  ...
  return withRequesterScopedProfileDiscovery(input, (discovery) => freezeRequesterScopedProfileTool(input, discovery));
}
...
export async function resolveRequesterScopedCatalogBindingsForProfileFreeze(
  ...
  return withRequesterScopedProfileDiscovery(input, (discovery) => freezeRequesterScopedProfileCatalog(input, discovery));
}
