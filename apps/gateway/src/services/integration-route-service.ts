...
export function createIntegrationRoutePort(port: IntegrationChannelPort): IntegrationRoutePort {
  return {
    ...
    listNotificationDeliveries: (...args) => port.listNotificationDeliveries(...args),
    listNotificationRules: (...args) => port.listNotificationRules(...args),
    listNotificationTargets: (...args) => port.listNotificationTargets(...args),
    createNotificationRule: (...args) => port.createNotificationRule(...args),
    createNotificationTarget: (...args) => port.createNotificationTarget(...args),
    dispatchNotificationEvent: (...args) => port.dispatchNotificationEvent(...args),
    requestNotification: (...args) => port.requestNotification(...args),
    sendTestNotification: (...args) => port.sendTestNotification(...args),
    updateNotificationRule: (...args) => port.updateNotificationRule(...args),
    updateNotificationTarget: (...args) => port.updateNotificationTarget(...args),
    upsertNotificationPresence: (...args) => port.upsertNotificationPresence(...args),
