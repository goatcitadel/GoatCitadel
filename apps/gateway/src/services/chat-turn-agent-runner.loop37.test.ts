...
describe("ChatTurnAgentRunner loop37 preflight and fallback behavior", () => {
        ...
        results: [
          {
            ...
            snippet: "Coverage report shows chat-turn-agent-runner as a top uncovered runtime file.",
          },
        ],
      },
    });
