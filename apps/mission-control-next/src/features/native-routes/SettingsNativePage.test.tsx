...
const mocks = vi.hoisted(() => ({
  ...
  createNotificationTarget: vi.fn(async () => ({})),
  updateNotificationTarget: vi.fn(async () => ({})),
  sendTestNotification: vi.fn(async () => ({ event: {}, deliveries: [], status: "no_targets" })),
  createNotificationRule: vi.fn(async () => ({})),
  updateNotificationRule: vi.fn(async () => ({})),
