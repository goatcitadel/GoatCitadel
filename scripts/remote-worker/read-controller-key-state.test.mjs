...
for(const engine of ['powershell.exe','pwsh.exe']) {
  test(`${engine}: read-only controller key probe compiles and returns only bounded metadata`,{ skip: process.platform !== "win32" },()=>{
  ...
  test(`${engine}: wrong-host launch refuses before probing`,{ skip: process.platform !== "win32" },()=>{
