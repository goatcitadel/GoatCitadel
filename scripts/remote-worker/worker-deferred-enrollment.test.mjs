...
for (const engine of ['powershell.exe', 'pwsh.exe']) {
  test(`${engine}: explicit deferred enrollment and ticket choice fail closed`, () => {
...
'PASS';`;
  ...
  test(`${engine}: GOATBOX launcher refuses a different machine before any file or service work`, () => {
