...
export const NEXT_RELEASE_SURFACE_STATUS_BY_SLUG = {
  ...
  "library-citadel": "ship",
  "library-citadel-overview": "ship",
  "library-citadel-wards": "ship",
...
export const NEXT_RELEASE_SURFACE_MANIFEST = withReleaseSurfaceStatus([
  ...
  {
    slug: "cowork",
    href: "/chat?mode=cowork",
    readySelector: ".mc-next-threaded-surface[data-mode=\"cowork\"]",
    canonicalArea: "cowork",
    canonicalSection: "workspace",
    expectedArea: "chat",
    expectedSection: "root",
    interaction: "open-inspector",
  },
  ...
  {
    slug: "library-citadel-wards",
    href: "/library/citadel-wards",
    readyText: "Active Wards",
    expectedArea: "library",
    expectedSection: "citadel-wards",
    interaction: "open-inspector",
  },
  {
    slug: "library-citadel-council",
    href: "/library/citadel-council",
    readyText: "Seated agents",
    expectedArea: "library",
    expectedSection: "citadel-council",
    interaction: "open-inspector",
  },
  {
    slug: "library-citadel-blueprint",
    href: "/library/citadel-blueprint",
    readyText: "Export",
    expectedArea: "library",
    expectedSection: "citadel-blueprint",
    interaction: "open-inspector",
  },
  {
    slug: "library-citadel-vault",
    href: "/library/citadel-vault",
    readyText: "Stored secrets",
    expectedArea: "library",
    expectedSection: "citadel-vault",
    interaction: "open-inspector",
  },
  {
    slug: "ops-activity",
...
export const NEXT_LEGACY_REDIRECT_MANIFEST = [
  { slug: "legacy-tab-chat", href: "/?tab=chat&surface=chat", expectedPath: "/chat", interaction: "open-inspector" },
  {
    ...
    href: "/?tab=assembly",
    expectedPath: "/chat",
    targetHref: "/chat?mode=cowork",
    expectedSearchParams: { mode: "cowork" },
    interaction: "open-inspector",
  },
  ...
  },
  {
    ...
    href: "/?surface=code",
    expectedPath: "/chat",
    targetHref: "/chat?mode=code",
    expectedSearchParams: { mode: "code" },
    interaction: "open-inspector",
  },
  {
