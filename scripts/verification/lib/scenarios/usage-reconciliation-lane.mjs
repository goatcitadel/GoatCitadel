  ...
  const commands = [
    ...
    },
    {
      ...
      args: [
        ...
        "src/services/llm-completion-memory-context.test.ts",
        "src/services/memory-context-service.test.ts",
        "src/services/llm-completion-helpers.test.ts",
        "src/services/llm-dispatch-guard.test.ts",
        "src/services/remote-worker-inference-llm-service-adapter.test.ts",
