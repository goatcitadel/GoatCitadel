...
const benchmarkCases = [
  ...
  },
  {
    ...
    baseline: {
      ...
      title: "TypeScript 6",
      command: pnpmExecutable,
      args: ["--filter", "@goatcitadel/mission-control", "typecheck"],
      displayCommand: "pnpm --filter @goatcitadel/mission-control typecheck",
    },
    candidate: {
      id: "ts7",
      title: "TypeScript 7 beta",
      command: process.execPath,
      args: [path.join(repoRoot, "scripts", "typescript", "run-ts7-workspace.mjs"), "--mode", "typecheck", "--group", "mission-control"],
      displayCommand: "node scripts/typescript/run-ts7-workspace.mjs --mode typecheck --group mission-control",
    },
  },
];
